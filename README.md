...
**cupmanager.net** — ingen server, inget byggsteg, alltid färska resultat.
...
- **Live-uppdatering**: hämtar om schemat var tredje minut när fliken är öppen.
...
- Hämtade matcher cachas i `localStorage` så att omladdningar är omedelbara;
  bakgrundsuppdatering sker automatiskt.
